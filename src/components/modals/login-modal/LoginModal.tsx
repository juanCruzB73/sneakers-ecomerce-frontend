...
export const LoginModal = () => {
  ...
  const handleSubmitUser=async(e: React.FormEvent)=>{
    e.preventDefault();
    await dispatch(startUpdateUser(userInfo))
  }
                ...
                <>
                  <form onSubmit={handleSubmitUser} className={style.loginModalInfoUserContainer}>
                  ...
                  </form>
                    {
                      ...
                      <>
                        <div className={style.loginModalAdminProfileButtons}>
                          <button type="button" onClick={()=>{navigate("/admin/productpanel");handlePopUpLogin()}}>Product Panel</button>
                          <button type="button" onClick={()=>{navigate("/admin/userpanel");handlePopUpLogin()}}>User Panel</button>
                        </div>
                      </>:
                      <>
                      </>
                    ...
                    <div className={style.loginModalProfileButtons}>
                      <button onClick={()=>{localStorage.removeItem("token");dispatch(onLogOut())}}>Log Out</button>
